        ...
        <Router>
          <div>
            ...
            <Routes>
              ...
              <Route path="/exercise/:workoutId" element={<StartWorkout />} />
              <Route path="/programs" element={<MyPrograms />} />
              <Route path="/phases/:programId" element={<ProgramPhases />} />
              <Route path="/workouts/:phaseId" element={<PhaseWorkouts />} />
              <Route path="/add-program" element={<AddProgram />} />
              <Route path="/add-phase/:programId?" element={<AddPhase />} />
              <Route path="/add-workout/:phaseId?" element={<AddWorkout />} />
